  ...
  <layout-content-vertical-nav :nav-menu-items="navMenuItems">
    ...
    <template #footer>
      <div class="d-flex justify-space-between">
        <span>DIREITO AUTORAL &copy; {{ new Date().getFullYear() }} <a
          href="https://hml.guiare.com"
          class="text-decoration-none"
        >Sistema de manutenção predial</a><span class="d-none d-md-inline">, Todos os direitos reservados</span></span>
        <div class="align-center d-none d-md-flex">
          <span>Feito à mão &amp; e feito com</span>
          <v-icon
            color="error"
            class="ms-2"
          >
